...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div class="text-[13px] leading-[20px] flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li class="flex items-center gap-4 py-2 relative  dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                        <span>
                            Petición
                            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Actuación por medio de la cual el ciudadano. de manera respetuosa, solicita a la Entidad cualquier información relacionada con la prestación de los servicios ofrecidos.</p>
                        </span>
                    </li>
                    <li class="flex items-center gap-4 py-2 relative  dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                        <span>
                            Queja
                            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Expresión o manifestación que le hace el ciudadano a la Entidad por la inconformidad que le generó la prestación de un servicio.</p>
                        </span>
                    </li>
                    <li class="flex items-center gap-4 py-2 relative  dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                        <span>
                            Reclamo
                            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Oposición o contrariedad presentada por el ciudadano, con el objeto de que la Entidad revise y evalúe una actuación relacionada con la prestación del servicio.</p>
                        </span>
                    </li>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <button
                            type="button"
                            x-data
                            x-on:click="$dispatch('open-modal', 'pqr-form')"
            ...
            <div class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-tr-lg lg:rounded-t-lg lg:rounded-r-lg  aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                <img src="{{ asset('images/banner_pqrs.png') }}" class="banner_pqrs" alt="banner_pqrs">
            </div>
        </main>
    </div>
    ...
    <x-modal-custom
        id="pqr-form"
        maxWidth="2xl"
        formId="pqr-form-data"
        formAction="/api/pqrs"
        formMethod="POST"
        primaryButtonText="Registrar PQR"
        primaryButtonType="submit"
        primaryButtonId="pqr-submit">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const form = document.getElementById('pqr-form-data');
        const submitButton = document.getElementById('pqr-submit');
        const generalError = document.getElementById('pqr-form-error');
        ...
        form.addEventListener('submit', async function (event) {
            ...
            /*
             * MUY IMPORTANTE:
             * Evita que el navegador haga el POST/GET
             * tradicional del formulario.
             */
            ...
            try {
                ...
                if (result.radicado) {
                    ...
                    window.location.href =
                        `/pqrs/confirmacion/${result.radicado}`;
                 ...
                 */
                showGeneralError(
                    'La PQR fue procesada, pero no se recibió el número de radicado.'
                );
                ...
                submitButton.textContent = 'Registrar PQR';
            }
        });
